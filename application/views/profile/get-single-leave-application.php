<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($application->leave_date)); ?></td>
        </tr>
        
        <tr>
            <th><?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('from'); ?></th>
            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($application->leave_from)); ?></td>       
            <th><?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('to'); ?></th>
            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($application->leave_to)); ?></td>
        </tr>         
