                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12 fn_existing_guardian <?php if(isset($post['guardian_id']) && $post['guardian_id'] == 'exist_guardian'){ ''; }else{ echo 'display'; } ?>">
                            <div class="item form-group">
                                ...
                                <button  class="btn btn-info glbscl-link-btn btn-xs"  name="find"  id="fn_find" type="button"><?php echo $this->lang->line('find'); ?> <?php echo $this->lang->line('guardian'); ?> <?php echo $this->lang->line('by'); ?> <?php echo $this->lang->line('phone'); ?></button>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="item form-group">
                                ...
                                <input  class="form-control col-md-7 col-xs-12"  name="gud_relation"  id="relation_with" value="<?php echo isset($post['gud_relation']) ?  $post['gud_relation'] : ''; ?>" placeholder="<?php echo $this->lang->line('relation_with'); ?>" type="text" autocomplete="off">
