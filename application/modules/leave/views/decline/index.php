<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bell-o"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('decline'); ?> <?php echo $this->lang->line('application'); ?></small></h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>                                                
                                                ...
                                                <?php if(has_permission(EDIT, 'leave', 'decline')){ ?>
                                                    <a href="<?php echo site_url('leave/decline/waiting/'.$obj->id); ?>" title="<?php echo $this->lang->line('decline'); ?>" class="btn btn-info btn-xs"><i class="fa fa-spinner"></i> <?php echo $this->lang->line('waiting'); ?> </a>
                                                <?php } ?>                                                    
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/decline/update/'.$application->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12" name="leave_date"  id="leave_date" value="<?php echo isset($application->leave_date) ?  date('d-m-Y', strtotime($application->leave_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('application'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12" name="leave_from"  id="leave_from" value="<?php echo isset($application->leave_from) ?  date('d-m-Y', strtotime($application->leave_from)) : ''; ?>" placeholder="<?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('from'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12" name="leave_to"  id="leave_to" value="<?php echo isset($application->leave_to) ?  date('d-m-Y', strtotime($application->leave_to)) : ''; ?>" placeholder="<?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('to'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_note"><?php echo $this->lang->line('decline'); ?> <?php echo $this->lang->line('reason'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea  class="form-control" name="leave_note" id="leave_note" required="required" placeholder="<?php echo $this->lang->line('decline'); ?> <?php echo $this->lang->line('reason'); ?>"><?php echo isset($application->leave_note) ?  $application->leave_note : ''; ?></textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a  href="<?php echo site_url('leave/decline/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    function get_user_by_role(role_id, user_id){  
       ...
       <?php } ?>
       get_leave_type_by_role(type_id);
   }
   ...
   function get_leave_type_by_role(type_id){
   
        var role_id = $('#role_id').val();
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_leave_type_by_role'); ?>",
