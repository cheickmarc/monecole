<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bell-o"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('approved'); ?> <?php echo $this->lang->line('application'); ?></small></h3>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/approve/update/'.$application->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12" name="leave_date"  id="leave_date" value="<?php echo isset($application->leave_date) ?  date($this->gsms_setting->sms_date_format, strtotime($application->leave_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('application'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12" name="leave_from"  id="leave_from" value="<?php echo isset($application->leave_from) ?  date($this->gsms_setting->sms_date_format, strtotime($application->leave_from)) : ''; ?>" placeholder="<?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('from'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12" name="leave_to"  id="leave_to" value="<?php echo isset($application->leave_to) ?  date($this->gsms_setting->sms_date_format, strtotime($application->leave_to)) : ''; ?>" placeholder="<?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('to'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_note"><?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('note'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea  class="form-control" name="leave_note" id="leave_note" required="required" placeholder="<?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('note'); ?>"><?php echo isset($application->leave_note) ?  $application->leave_note : ''; ?></textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a  href="<?php echo site_url('leave/approve/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
