                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/application/edit/'.$application->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="form-group"> 
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_date"><?php echo $this->lang->line('application'); ?> <?php echo $this->lang->line('date'); ?><span class="required"> *</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="leave_date"  id="edit_leave_date" value="<?php echo isset($application->leave_date) ?  date($this->gsms_setting->sms_date_format, strtotime($application->leave_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('application'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('leave_date'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group"> 
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_to"><?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('to'); ?><span class="required"> *</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="leave_to"  id="edit_leave_to" value="<?php echo isset($application->leave_to) ?  date($this->gsms_setting->sms_date_format, strtotime($application->leave_to)) : ''; ?>" placeholder="<?php echo $this->lang->line('leave'); ?> <?php echo $this->lang->line('to'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('leave_to'); ?></div>
                                        </div>
                                    </div>
