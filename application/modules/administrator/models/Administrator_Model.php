...
class Administrator_Model extends MY_Model {
    ...
    public function get_user_list($role_id, $class_id, $user_id) {
        ...
        if ($role_id == STUDENT) {
            ...
            $this->db->select('S.*, U.email, U.temp_password, U.role_id, U.status AS login_status ');
            ...
            $this->db->select('T.*, U.email, U.temp_password, U.role_id, U.status AS login_status ');
            ...
            $this->db->select('G.*, U.email, U.temp_password, U.role_id, U.status AS login_status ');
            ...
            $this->db->select('E.*, U.email, U.temp_password, U.role_id, D.name AS designation, U.status AS login_status ');
