                           ...
                           <div class="col-sm-6 col-xs-6  col-sm-offset-3 col-xs-offset-3 layout-box">
                               <p>
                                   ...
                                   <?php if(isset($student) && !empty($student)){ ?>
                                        <p>
                                            <strong><?php echo $this->lang->line('student'); ?> :</strong> <?php echo $student->name; ?>, 
                                            <strong><?php echo $this->lang->line('guardian'); ?>:</strong> <?php echo $student->guardian_name; ?>
                                        </p>
                                       <p>                                            
                                ...
                                <tbody>   
                                    ...
                                    $count = 1; if(isset($sbalance) && !empty($sbalance)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date('F, Y', strtotime('1-'.$obj->month)); ?></td>                                            
                                        ...
                                        <?php } ?>
                                        <tr>
                                            <td colspan="5"><strong><?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('balance'); ?> (-)</strong></td>
