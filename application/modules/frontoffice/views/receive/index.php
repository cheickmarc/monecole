                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($receives) && !empty($receives)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->receive_date)); ?></td>
                                            <td>
                                                ...
                                                <?php if(has_permission(VIEW, 'frontoffice', 'receive')){ ?>
                                                    ...
                                                    <?php if($obj->attachment){ ?>
                                                        <a href="<?php echo UPLOAD_PATH; ?>/postal/<?php echo $obj->attachment; ?>"  target="_blank" class="btn btn-success btn-xs"><i class="fa fa-download"></i> <?php echo $this->lang->line('download'); ?></a>
                                                    <?php } ?>
                                                <?php } ?>    
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontoffice/receive/edit/'.$receive->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="receive_date"><?php echo $this->lang->line('receive'); ?> <?php echo $this->lang->line('date'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="receive_date"  id="edit_receive_date" value="<?php echo isset($receive) ?  date($this->gsms_setting->sms_date_format, strtotime($receive->receive_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('receive'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('receive_date'); ?></div>
                                    </div>
                                </div>  
