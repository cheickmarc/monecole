                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($dispatches) && !empty($dispatches)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->dispatch_date)); ?></td>
                                            <td>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('frontoffice/dispatch/edit/'.$dispatch->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dispatch_date"><?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('date'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="dispatch_date"  id="edit_dispatch_date" value="<?php echo isset($dispatch) ?  date($this->gsms_setting->sms_date_format, strtotime($dispatch->dispatch_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('dispatch_date'); ?></div>
                                    </div>
                                </div>  
