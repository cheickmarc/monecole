                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($calllogs) && !empty($calllogs)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->call_date)); ?></td>
                                            <td>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('frontoffice/calllog/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo isset($phone) ?  $phone : ''; ?>" placeholder="<?php echo $this->lang->line('name'); ?>" required="required" type="number" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="call_date"  id="add_call_date" value="<?php echo isset($call_date) ?  date($this->gsms_setting->sms_date_format, strtotime($call_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('call_date'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="next_follow_up"  id="add_next_follow_up" value="<?php echo isset($next_follow_up) ?  date($this->gsms_setting->sms_date_format, strtotime($next_follow_up)) : ''; ?>" placeholder="<?php echo $this->lang->line('follow_up'); ?>" type="text" autocomplete="off">
