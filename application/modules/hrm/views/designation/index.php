                               ...
                               <?php echo form_open(site_url('hrm/designation/edit/'.$designation->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input  class="form-control col-md-7 col-xs-12"  name="name" value="<?php echo isset($designation) ? $designation->name : ''; ?>"  placeholder="<?php echo $this->lang->line('designation'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
