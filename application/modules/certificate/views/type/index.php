                            ...
                            <div class="x_content"> 
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="item form-group">
                                         ...
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($certificate) ? $certificate->name : ''; ?>" placeholder="<?php echo $this->lang->line('certificate'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text">
                                             <div class="help-block"><?php echo form_error('name'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="top_title"><?php echo $this->lang->line('school'); ?> <?php echo $this->lang->line('name'); ?> <span class="required">*</span></label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control col-md-7 col-xs-12"  name="top_title"  id="top_title" value="<?php echo isset($certificate) ? $certificate->top_title : ''; ?>" placeholder="<?php echo $this->lang->line('certificate'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text">
                                             <div class="help-block"><?php echo form_error('top_title'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="footer_left"> <?php echo $this->lang->line('footer_left'); ?></label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control col-md-7 col-xs-12"  name="footer_left"  id="footer_left" value="<?php echo isset($certificate) ? $certificate->footer_left : ''; ?>" placeholder="<?php echo $this->lang->line('footer_left'); ?>" type="text">
                                             <div class="help-block"><?php echo form_error('footer_left'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="footer_middle"> <?php echo $this->lang->line('footer_middle'); ?></label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control col-md-7 col-xs-12"  name="footer_middle"  id="footer_middle" value="<?php echo isset($certificate) ? $certificate->footer_middle : ''; ?>" placeholder="<?php echo $this->lang->line('footer_middle'); ?>" type="text">
                                             <div class="help-block"><?php echo form_error('footer_middle'); ?></div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="item form-group">
                                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="footer_right"> <?php echo $this->lang->line('footer_right'); ?></label>
                                         <div class="col-md-9 col-sm-9 col-xs-12">
                                             <input  class="form-control col-md-7 col-xs-12"  name="footer_right"  id="footer_right" value="<?php echo isset($certificate) ? $certificate->footer_right : ''; ?>" placeholder="<?php echo $this->lang->line('footer_right'); ?>" type="text">
                                             <div class="help-block"><?php echo form_error('footer_right'); ?></div>
                                         </div>
                                     </div>
