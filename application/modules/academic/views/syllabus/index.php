                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('academic/syllabus/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 quick-field"  name="class_id"  id="class_id" required="required" onchange="get_subject_by_class(this.value, '', 'add');" >
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('academic/syllabus/edit/'.$syllabus->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($syllabus->title) ?  $syllabus->title : ''; ?>" placeholder="<?php echo $this->lang->line('syllabus'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 quick-field"  name="class_id"  id="class_id" required="required" onchange="get_subject_by_class(this.value, '', 'edit');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($classes as $obj ){ ?>
                                            <?php
                                                if($this->session->userdata('role_id') == TEACHER){
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <a target="_blank" href="<?php echo UPLOAD_PATH; ?>/syllabus/<?php echo $syllabus->syllabus; ?>"><?php echo $syllabus->syllabus; ?></a> <br/>
                                        <?php } ?>
                                        <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                            <input  class="form-control col-md-7 col-xs-12"  name="syllabus"  id="syllabus" type="file">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note"><?php echo $this->lang->line('note'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="note"  id="note" placeholder="<?php echo $this->lang->line('note'); ?>"><?php echo isset($syllabus->note) ?  $syllabus->note : ''; ?></textarea>
                                        <div class="help-block"><?php echo form_error('note'); ?></div>
                                    </div>
                                </div>
...
<script type="text/javascript"> 
    ...
    <?php if(isset($edit)){ ?>
        get_subject_by_class('<?php echo $syllabus->class_id; ?>', '<?php echo $syllabus->subject_id; ?>', 'edit');
    <?php } ?>
    
    function get_subject_by_class(class_id, subject_id, type){       
        ...
        $.ajax({       
            ...
            success: function(response){                                                   
               if(response)
               {
                   $('#'+type+'_subject_id').html(response);                   
               }
            }
        });                  
