                                            ...
                                            <div class="admit-card-block">
                                                <div class="admit-card-top">
                                                    ...
                                                    <div class="admit-card-school">
                                                        <h2><?php echo isset($admit_setting->school_name) && $admit_setting->school_name != '' ? $admit_setting->school_name : $this->gsms_setting->school_name; ?></h2>
                                                        <p><?php echo isset($admit_setting->school_address) && $admit_setting->school_address != '' ? $admit_setting->school_address : $this->gsms_setting->address;; ?></p>
                                                        <p><?php echo $this->lang->line('phone'); ?>: <?php echo isset($admit_setting->phone) && $admit_setting->phone != '' ? $admit_setting->phone : $this->gsms_setting->phone;; ?></p>
                                                    </div>
                                                </div>
                                                <div class="admit-card">
                                                    <h3><span><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('admit'); ?> <?php echo $this->lang->line('card'); ?></span></h3>
                                                </div>
                                                <div class="admit-card-main">                                                    
                                                    ...
                                                    <div class="admit-card-info">
                                                        <p><span class="admit-card-title"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('id'); ?></span><span class="admit-card-value">: <?php echo $obj->roll_no; ?></span></p>
                                                        <p><span class="admit-card-title"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('name'); ?></span><span class="admit-card-value">: <?php echo $obj->name; ?></span></p>
                                                        ...
                                                        <p><span class="admit-card-title"><?php echo $this->lang->line('birth_date'); ?></span><span class="admit-card-value">: <?php echo date($this->gsms_setting->sms_date_format, strtotime($obj->dob)); ?></span></p>
                                                    </div>
                                                    <div class="admit-card-subject">
                                                        <div class="admit-exam"><?php echo $this->lang->line('exam'); ?>: <?php if(isset($exam) && !empty($exam)){ echo $exam->title; } ?></div>
                                                        <div class="subject-heading"><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('subject'); ?>:</div>
...
<script type="text/javascript">
    ...
    function get_student_by_section(section_id, student_id){       
        ...
        $.ajax({       
            ...
            data   : { section_id: section_id, student_id: student_id, is_all:true},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {
