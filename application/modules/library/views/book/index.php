                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('library/book/edit/'.$book->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($book->title) ?  $book->title : ''; ?>" placeholder="<?php echo $this->lang->line('book'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="custom_id"  id="custom_id" value="<?php echo isset($book->custom_id) ?  $book->custom_id : ''; ?>" placeholder="<?php echo $this->lang->line('book_id'); ?>" readonly="readonly" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('custom_id'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="isbn_no"  id="isbn_no" value="<?php echo isset($book->isbn_no) ?  $book->isbn_no : ''; ?>" placeholder="<?php echo $this->lang->line('isbn_no'); ?>" type="text"/>
                                        <div class="help-block"><?php echo form_error('isbn_no'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="edition"  id="edition" value="<?php echo isset($book->edition) ?  $book->edition : ''; ?>" placeholder="<?php echo $this->lang->line('edition'); ?>" type="text"/>
                                        <div class="help-block"><?php echo form_error('edition'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="author"  id="author" value="<?php echo isset($book->author) ?  $book->author : ''; ?>" placeholder="<?php echo $this->lang->line('author'); ?>" type="text"/>
                                        <div class="help-block"><?php echo form_error('author'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="language"  id="language" value="<?php echo isset($book->language) ?  $book->language : ''; ?>" placeholder="<?php echo $this->lang->line('language'); ?>" type="text"/>
                                        <div class="help-block"><?php echo form_error('language'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="price"  id="price" value="<?php echo isset($book->price) ?  $book->price : ''; ?>" placeholder="<?php echo $this->lang->line('price'); ?>" type="text"/>
                                        <div class="help-block"><?php echo form_error('price'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="qty"  id="qty" value="<?php echo isset($book->qty) ?  $book->qty : ''; ?>" placeholder="<?php echo $this->lang->line('quantity'); ?>" required="required" type="text"/>
                                        <div class="help-block"><?php echo form_error('qty'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="rack_no"  id="rack_no" value="<?php echo isset($book->rack_no) ?  $book->rack_no : ''; ?>" placeholder="<?php echo $this->lang->line('almira_rack'); ?>"  type="text"/>
                                        <div class="help-block"><?php echo form_error('rack_no'); ?></div>
                                    </div>
                                </div>                                
