...
class Resultcard_Model extends MY_Model {
    ...
    public function get_student_list( $class_id = null, $section_id = null, $academic_year_id = null){
        ...
        $this->db->select('S.*, D.amount, D.title AS discount, G.name AS guardian, E.roll_no, E.section_id, E.class_id, U.email, U.role_id,  C.name AS class_name, SE.name AS section');
