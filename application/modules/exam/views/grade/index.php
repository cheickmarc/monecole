                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('exam/grade/edit/'.$grade->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($grade->name) ?  $grade->name : ''; ?>" placeholder="<?php echo $this->lang->line('exam_grade'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="point"  id="point" value="<?php echo isset($grade->point) ?  $grade->point : ''; ?>" placeholder="<?php echo $this->lang->line('grade_point'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('point'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="mark_from"  id="mark_from" value="<?php echo isset($grade->mark_from) ?  $grade->mark_from : ''; ?>" placeholder="<?php echo $this->lang->line('mark_from'); ?>" required="required" type="number">
                                        <div class="help-block"><?php echo form_error('mark_from'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="mark_to"  id="mark_to" value="<?php echo isset($grade->mark_to) ?  $grade->mark_to : ''; ?>" placeholder="<?php echo $this->lang->line('mark_to'); ?>" required="required" type="number">
                                        <div class="help-block"><?php echo form_error('mark_to'); ?></div>
                                    </div>
                                </div>
