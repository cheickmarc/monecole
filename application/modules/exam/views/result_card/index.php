    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12" name="academic_year_id" id="academic_year_id" required="required">
                                ...
                                <option value="<?php echo $obj->id; ?>" <?php if(isset($academic_year_id) && $academic_year_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->session_year; if($obj->is_running){ echo ' ['.$this->lang->line('running_year').']'; } ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
            ...
            <?php  if (isset($student) && !empty($student)) { ?>
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-4 col-xs-6 col-sx-offset-3 layout-box">
                        <p>
            ...
            <div class="x_content">
                ...
                <table id="datatable-responsive" class="table table-striped_ table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    ?>
                        ...
                        <?php $total_mark = $mark->written_mark+$mark->tutorial_mark+$mark->practical_mark+$mark->viva_mark; ?>
                        ...
                        <?php $exam = get_exam_result($academic_year_id, $ex->id, $student_id, $academic_year_id, $class_id, $section_id); ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $total_mark > 0 ? $total_mark : ''; ?></td>
                            <td><?php echo $obtain_total_mark > 0 ? $obtain_total_mark : ''; ?></td>
