                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody id="fn_mark">   
                        ...
                        if (isset($subjects) && !empty($subjects)) {
                            ...
                            <?php $lh = get_lowet_height_mark($academic_year_id, $exam_id, $class_id, $section_id, $obj->subject_id ); ?>
                            <?php $position = get_position_in_subject($academic_year_id, $exam_id, $class_id, $section_id, $obj->subject_id , $obj->obtain_total_mark); ?>
                                <tr>
