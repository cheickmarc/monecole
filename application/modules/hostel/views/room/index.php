                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('hostel/room/edit/'.$room->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="room_no"  id="room_no" value="<?php echo isset($room->room_no) ?  $room->room_no : ''; ?>" placeholder="<?php echo $this->lang->line('room_no'); ?>" required="required" type="text">
                                        <div class="help-block"><?php echo form_error('room_no'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="total_seat"  id="total_seat" value="<?php echo isset($room->total_seat) ?  $room->total_seat : ''; ?>" placeholder="<?php echo $this->lang->line('seat_total'); ?>" required="required" type="number">
                                        <div class="help-block"><?php echo form_error('total_seat'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cost"><?php echo $this->lang->line('cost_per_seat'); ?> (<?php echo $this->gsms_setting->currency_symbol; ?>)</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="cost"  id="cost" value="<?php echo isset($room->cost) ?  $room->cost : ''; ?>" placeholder="<?php echo $this->lang->line('cost_per_seat'); ?>" type="number">
                                        <div class="help-block"><?php echo form_error('cost'); ?></div>
                                    </div>
                                </div>
