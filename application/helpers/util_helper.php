...
if (!function_exists('get_routines_by_day')) {
    ...
    function get_routines_by_day($day, $class_id =null, $section_id = null, $academic_year_id = null) {
        $ci = & get_instance();
...
if (!function_exists('get_student_attendance')) {
    ...
    function get_student_attendance($student_id, $academic_year_id, $class_id, $section_id  = null, $year = null, $month = null, $day = null) {
        $ci = & get_instance();
        $field = 'day_' . abs($day);
...
if (!function_exists('get_exam_attendance')) {
    ...
    function get_exam_attendance($student_id, $academic_year_id, $exam_id, $class_id, $section_id = null, $subject_id = null) {
        $ci = & get_instance();
...
if (!function_exists('get_exam_mark')) {
    ...
    function get_exam_mark($student_id, $academic_year_id, $exam_id, $class_id, $section_id = null, $subject_id = null) {
        $ci = & get_instance();
        $ci->db->select('M.*');
...
if (!function_exists('get_subject_list')) {
    ...
    function get_subject_list($academic_year_id, $exam_id, $class_id, $section_id, $student_id) {
        $ci = & get_instance();
...
if (!function_exists('get_lowet_height_mark')) {
    ...
    function get_lowet_height_mark($academic_year_id, $exam_id, $class_id, $section_id = null, $subject_id = null) {
        $ci = & get_instance();
...
if (!function_exists('get_lowet_height_result')) {
    ...
    function get_lowet_height_result($academic_year_id, $exam_id, $class_id, $section_id = null, $student_id = null) {
        $ci = & get_instance();
...
if (!function_exists('get_position_in_subject')) {
    ...
    function get_position_in_subject($academic_year_id, $exam_id, $class_id, $section_id, $subject_id, $mark) {
...
if (!function_exists('get_final_result')) {
    ...
    function get_final_result($academic_year_id, $class_id, $section_id = null, $student_id = null){
...
if (!function_exists('get_exam_wise_markt')) {
    ...
    function get_exam_wise_markt($academic_year_id, $exam_id, $class_id, $section_id, $student_id) {
        $ci = & get_instance();
...
if (!function_exists('get_position_in_exam')) {
    ...
    function get_position_in_exam($academic_year_id, $exam_id, $class_id, $section_id, $mark) {
...
if (!function_exists('get_position_in_class')) {
    ...
    function get_position_in_class($academic_year_id, $class_id, $mark) {
        ...
        $sql = "SELECT id, avg_grade_point, FIND_IN_SET( avg_grade_point,(
                SELECT GROUP_CONCAT( avg_grade_point  ORDER BY avg_grade_point DESC ) 
                FROM final_results WHERE class_id = $class_id AND academic_year_id = $academic_year_id  ))
                AS rank 
                FROM final_results
                WHERE class_id = $class_id  AND academic_year_id = $academic_year_id  AND avg_grade_point = $mark"; 
...
if (!function_exists('get_user_by_role')) {
    ...
    function get_user_by_role($role_id, $user_id) {
        ...
        if ($role_id == STUDENT) {
            ...
            $ci->db->select('S.*, ST.type, SG.group, G.name AS guardian, E.roll_no, E.section_id, E.class_id, U.email, U.role_id, R.name AS role, C.name AS class_name, SE.name AS section, D.title AS discount');
            $ci->db->from('enrollments AS E');
            ...
            $ci->db->join('student_groups AS SG', 'SG.id = S.group_id', 'left');
...
if (!function_exists('get_guardian_access_data')) {
 ...
 function get_guardian_access_data($type = NULL){
        ...
        $ci->db->join('classes AS C', 'C.id = E.class_id', 'left');
        $ci->db->join('sections AS SE', 'SE.id = E.section_id', 'left');
        $ci->db->where('E.academic_year_id', $ci->academic_year_id);
...
if (!function_exists('get_teacher_access_data')) {
 ...
 function get_teacher_access_data(){
        ...
        $ci->db->from('routines AS R');            
        $ci->db->where('R.teacher_id', $teacher_id); 
        $result = $ci->db->get()->result();
        ...
        $ci->db->where('C.teacher_id', $teacher_id); 
        $result = $ci->db->get()->result();
...
if (!function_exists('xx_get_student_access_data')) {
    
 function xx_get_student_access_data($type = NULL){
        ...
        if($type == 'student'){                
            ...
            $ci->db->join('teachers AS T', 'T.id = R.teacher_id', 'left');
            $ci->db->join('classes AS C', 'C.id = R.class_id', 'left');
            $ci->db->where('R.teacher_id', $student_id); 
            $result = $ci->db->get()->result();
